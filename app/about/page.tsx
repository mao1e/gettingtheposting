            ...
            <section className='flex flex-col sm:flex-row pt-20'>
                <div className="p-6">
                    ...
                    <p>
                        ...
                        It didn't stop there! After commissioning I was posted to an Air Force Battalion as a Logistics Officer...There were many changes in my journey and I hope that through this initiative I can help parents and enlistees understand more the many paths their NS journey can take.
                    </p>
                </div>
